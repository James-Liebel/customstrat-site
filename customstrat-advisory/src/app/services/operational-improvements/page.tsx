              ...
              <div className="divide-y divide-slate-200">
                {examples.map((ex, i) => (
                  <div key={i} className="grid grid-cols-1 md:grid-cols-3 gap-6 py-8">
                    <div className="text-slate-900 font-semibold text-lg">{ex.projectSummary}</div>
                    <div className="text-slate-700 leading-relaxed">{ex.problem}</div>
                    <div className="text-slate-700 leading-relaxed">{ex.approach}</div>
                  </div>
                ))}
              </div>
            </div>
