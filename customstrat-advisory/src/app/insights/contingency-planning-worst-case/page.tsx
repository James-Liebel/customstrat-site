        ...
        <article className="cs-article">
          ...
          <div className="cs-surface">
            <div className="cs-body">
              ...
              <section className="cs-section">
                <h2 className="cs-h2">What does contingency planning for the next worst case scenario look like?</h2>

                <p>
                  If a global pandemic doesn’t highlight the importance of contingency planning for what have traditionally been considered low probability events, I don’t know what will. Here are some ideas on protecting your ass(ets).
                </p>

                <h3 className="cs-h3">For insurance consumers:</h3>

                <p>
                  Take a close look at what life events you’re insured for, including long-term care, life insurance, and flood insurance. Think of it as stocking up on toilet paper during a pandemic, only potentially life-saving and life savings-saving.
                </p>

                <p>
                  Review specific coverages such as auto insurance. If you’re driving 80% less due to working at home, you may be able to significantly lower your premium. In the same vein, if you bought a trampoline to entertain the kids, make sure your home insurance policy actually covers it; and if not, look at extended coverage to protect yourself. If the past year has taught us anything, it’s hope for the best – prepare for the worst.
                </p>
                ...
                <h3 className="cs-h3">For insurance carriers:</h3>

                <p>
                  Consider new kinds of coverage to offer when major events like a pandemic or extreme weather events occur. There may be increased interest in liability coverage for disease transmission or life insurance throughout age bands.
                </p>

                <p>
                  Proactively audit coverages and reach out to customers to offer appropriate discounts and suggest coverage additions. By looking out for your customers, you’ll be grooming long-term relationships.
                </p>

                <p>
                  Invest in digital interfaces and insights to support better customer experiences. Why? Customers are looking to review their coverages and plan for risks, and yet are also staying away from agent offices. Make it easier by enhancing their ability to review and change policies remotely. It’s also a smart idea to increase data intelligence to identify insurable customer purchase events and to identify when customers might be shopping around.
                </p>

                <p>
                  Pursue relationship-deepening efforts with bundled pricing, extending payment plans, and payment fee forgiveness. Also look at setting up automatic payments and discounts for EFT direct debit payments to ensure customers can pay more easily and to increase customer retention. Investing in relationships during these troubled times will payback with increased loyalty over the coming years.
                </p>
              </section>
