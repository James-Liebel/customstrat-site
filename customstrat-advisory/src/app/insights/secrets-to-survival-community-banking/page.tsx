...
export default function SecretsToSurvivalCommunityBanking() {
  return (
    <main className="cs-shell--library relative">
      ...
      <JsonLd schema={articleSchema("secrets-to-survival-community-banking")} />
      <JsonLd schema={articleBreadcrumbSchema("secrets-to-survival-community-banking")} />
        ...
        <article className="cs-article">
          ...
          <header className="cs-hero">
            <div className="cs-hero-inner">
              <h1 className="cs-title">Secrets to Survival in Community Banking</h1>
              <h2 className="cs-subtitle">What is and is NOT correlated to Success</h2>
          ...
          <div className="cs-surface">
            <div className="cs-body">
              ...
              <section className="cs-exhibit">
                <h3 className="cs-exhibit-title">Exhibit 1: Profile of banks analyzed</h3>
                <div className="cs-exhibit-frame">
                  <img src="/images/survival-exhibit-1.png" alt="Profile of banks analyzed" />
                </div>
              </section>
              ...
              <section className="cs-section">
                ...
                <h3 className="cs-h3">3.&nbsp;&nbsp;&nbsp;&nbsp;Regional Location.</h3>
              ...
              <section className="cs-exhibit">
                ...
                <div className="cs-exhibit-frame">
                  <img src="/images/survival-exhibit-4.png" alt="Non-Factors to success" />
                </div>
              </section>

              <section className="cs-section">
                <h2 className="cs-h2">Two Factors that DO Drive Success</h2>

                <p>
                  The leading banks tend to have 2 common drivers: efficiency and targeted markets.
                </p>

                <h3 className="cs-h3">1.&nbsp;&nbsp;&nbsp;&nbsp;Effective Efficiency.</h3>
                ...
                <h3 className="cs-h3">2.&nbsp;&nbsp;&nbsp;&nbsp;Targeted Local Markets.</h3>
              ...
              {/* Exhibit 3 */}
              <section className="cs-exhibit">
                <h3 className="cs-exhibit-title">Exhibit 3: Factors driving success</h3>
                <div className="cs-exhibit-frame">
                  <img src="/images/survival-exhibit-3.png" alt="Factors driving success" />
                </div>
              </section>

              <section className="cs-section">
                <h2 className="cs-h2">The Value of Strategic Commitment</h2>
                ...
                <p>
                  Another illustration of strategic commitment is focus on affluent consumers and larger commercial customers. Banks with a particular focus on larger customers (evidenced by less than 45% of deposits being FDIC insured) are 70% more likely to be winners than laggards. On the other hand, banks with an average amount of large accounts (between 45% and 55% of deposits FDIC insured) are 64% more likely to be laggards.
                </p>
              </section>

              {/* Exhibit 4 */}
              <section className="cs-exhibit">
                <h3 className="cs-exhibit-title">Exhibit 4: Strategic Commitment</h3>
                <div className="cs-exhibit-frame">
                  <img src="/images/survival-exhibit-2.png" alt="Strategic Commitment" />
                </div>
              </section>
