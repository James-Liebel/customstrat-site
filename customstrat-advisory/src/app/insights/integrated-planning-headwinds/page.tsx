...
export default function IntegratedPlanningAmidstTheHeadwinds() {
  return (
    <main className="cs-shell--library relative">
      ...
      <JsonLd schema={articleSchema("integrated-planning-headwinds")} />
      <JsonLd schema={articleBreadcrumbSchema("integrated-planning-headwinds")} />
          ...
          <div className="cs-surface">
            <div className="cs-body">
              ...
              <section className="cs-section">
                ...
                <h3 className="cs-h3">Prioritize investments in alignment with a very granular strategy.</h3>
                <p>
                  In any scenario, but particularly in a scenario with limited resources, the business needs to have clarity on where NOT to invest, just as much as where TO invest. The investment thesis will remain vague and returns insufficient without enough granularity in the strategy (sub-segments, micro-markets, capabilities).
                </p>
                ...
                <h3 className="cs-h3">Do not gold plate, even in areas of strategic growth.</h3>
                <p>
                ...
                <h3 className="cs-h3">Invest in pricing specificity and review pricing mechanisms.</h3>
                <p>
                  In these times of increasing cost pressures, granular pricing can make a significant impact. Price leakage is one key area to address in B2B situations. In one such case, pricing variations at the customer level, contract language, and elasticity analysis indicated that the company left meaningful revenue share on the table due to historical practices implemented. Following the updated pricing practices generated a revenue lift of ~5% within one year, with minimal impact to retention.
                </p>

                <h3 className="cs-h3">Keep the funding approach agile.</h3>
                <p>
              ...
              <section className="cs-section">
                ...
                <h3 className="cs-h3">Take advantage of structural trends.</h3>
                <p>
                  The marketplace has changed dramatically over the past couple of years in areas such as remote work, increased service interactions via digital channels, reduced business travel, etc. Ensure cost savings associated with these changes are explicitly banked.
                </p>

                <h3 className="cs-h3">Outsource areas where prudent.</h3>
                <p>
                  Seek to gain operating efficiencies by outsourcing where there is insufficient differentiation, limited supply chain risks, and sufficient suppliers at scale. For example, many banks and insurance companies still maintain customer communication and statement operations internally. Digital communication providers invest hundreds of millions to drive to state-of-the-art capabilities and scale in this area, far exceeding what most companies can achieve on their own - both in terms of costs and customer experience.
                </p>

                <h3 className="cs-h3">Remove any “waste” in the system</h3>
                <p>
                  , for example, multiple experiments with the same objective and duplication of activities. This is only achieved with a cross-functional view, and not biased in “the way we’ve always done it”. With the same eagerness that children hunt for Easter Eggs, ask a neutral team to identify areas of duplication or lingering efforts, lacking results that could be candidates for elimination.
                </p>

                <h3 className="cs-h3">Ensure the largest cost areas have targeted efficiency plans that ALIGN with the strategic priorities.</h3>
                <p>
                  All too often, the cost reduction efforts are disjointed from the strategic goals. For example, one organization sought to reduce digital marketing spend by 40% and yet held a growth expectation of new millennial customers of 25%.
                </p>

                <h3 className="cs-h3">Be ready to divest if not the natural owners of the business.</h3>
                <p>
                  The ideal would be to do so in good market conditions. However, the focus will help to get ready for the next upswing.
                </p>
              </section>
