...
export default function AStrategicPlanningTuneUpForUncertainTimes() {
  return (
    <main className="cs-shell--library relative">
      ...
      <JsonLd schema={articleSchema("strategic-planning-tune-up")} />
      <JsonLd schema={articleBreadcrumbSchema("strategic-planning-tune-up")} />
        ...
        <article className="cs-article">
          ...
          <div className="cs-surface">
            <div className="cs-body">
              ...
              <section className="cs-section">
                <h2 className="cs-h2">1. External environment review: Explicitly revisit your assumptions with sufficient frequency</h2>
                ...
                <h3 className="cs-h3">Incorporate structural changes</h3>
                <p>
                  The last two years have seen several structural changes occur rapidly - accelerated consumer digital acceptance, the emergence of hybrid work, skill-set shortages, shifting populations between cities, local supply chains vs. global, etc. Take a step back to ensure the strategy is aligned with the shifting market context, adjusting priorities accordingly.
                </p>

                <h3 className="cs-h3">Increase frequency of macro-environment / driver reviews</h3>
                <p>
                  In this volatile environment, revisit macro indicators and demand-supply drivers regularly (e.g., monthly). In that process, explicitly link major environmental changes to any required strategic priorities adjustments.
                </p>

                <h3 className="cs-h3">Create triggers and playbooks for big disruptions</h3>
                <p>
                  Identify the top 10-15 external indicators that might impact the strategy and institute trigger points to take action. For example, increasing penetration of advanced driver assistance systems could change auto insurance's go-to-market strategy. Elevate the topic for strategic trade-off discussions when the indicators are out of range. Monitor these indicators on a quarterly or semi-annual basis.
                </p>
              ...
              <section className="cs-section">
                <h2 className="cs-h2">2. Internal strategic assessment: Assess capabilities; align priorities to changing times</h2>
              ...
              <section className="cs-section">
                <h2 className="cs-h2">3. Set the strategy: Be nimble and drive explicit choices collaboratively</h2>

                <h3 className="cs-h3">Be bold and force more choices</h3>
                <p>
                  Resources are always limited and particularly constrained in the current environment. Decide which initiatives will not be touched and which can be delayed or stopped altogether. Explore inorganic growth, given valuation levels of targets, and attract top-tier tech talent, given slowdown announcements by tech companies.
                </p>

                <h3 className="cs-h3">Build &quot;One Plan&quot; with early cross-functional participation</h3>
                <p>
                  Ensure early involvement of cross-functional partners like HR, marketing, risk, and IT to allow for effective capacity planning given constrained resources. This also allows for diverse points of view, appreciation of the effort required as a team, and rallying behind a joint plan vs. a handed-down one.
                </p>

                <h3 className="cs-h3">Communicate more frequently and recharge the organization</h3>
                <p>
                  Strategy used to be communicated once a year and revisited the following year. With pivots and re-allocations often occurring due to changing industry dynamics, communicate more regularly than usual. Ensure that the cascading of pivots / re-allocation decisions are happening as their execution lies with teams and front-line employees. Across the leadership levels, ensure every individual understands the change, what it means for them, and how different &apos;Monday morning&apos; will be.
                </p>
