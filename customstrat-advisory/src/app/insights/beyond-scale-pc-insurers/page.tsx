          ...
          <div className="cs-surface">
            <div className="cs-body">
              ...
              <section className="cs-section">
                ...
                <h3 className="cs-h3">What exactly are winning choices?</h3>
              ...
              <section className="cs-exhibit">
                ...
                <div className="cs-exhibit-frame">
                  <img src="/images/exhibit-1.png" alt="Profile of Carriers analyzed" />
                </div>
              </section>
              ...
              <section className="cs-exhibit">
                ...
                <div className="cs-exhibit-frame">
                  <img src="/images/exhibit-4.png" alt="Different Models for Winners + Top 3 – Expense Ratio vs. Loss Ratio" />
                </div>
              </section>
