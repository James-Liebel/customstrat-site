...
export default function TheSofterSideOfTransformationFiveCs() {
  return (
    <main className="cs-shell--library relative">
      ...
      <JsonLd schema={articleSchema("softer-side-of-transformation")} />
      <JsonLd schema={articleBreadcrumbSchema("softer-side-of-transformation")} />
        ...
        <article className="cs-article">
          ...
          <div className="cs-surface">
            <div className="cs-body">
              ...
              <section className="cs-section">
                <h2 className="cs-h2">Commitment - Stack Hands the Top</h2>
                ...
                <div className="cs-callout">
                  <p className="mb-0">
                    <strong>Tangible Tip:</strong> Make the challenging executive leadership changes at the outset of the transformation. Too often, the transformational effort begins with one or two executives who are not proponents of the change, with the expectation that they will self-select somewhere along the journey. This only seeds disbelief for the entire organization and sets the effort back by 3-6 months.
                  </p>
                </div>
              ...
              <section className="cs-section">
                <h2 className="cs-h2">2. Capabilities - Talent is at the Core</h2>
                ...
                <div className="cs-callout">
                  <p className="mb-0">
                    <strong>Tangible Tip:</strong> The core team comprised of 5-6 individuals can serve as the driving force behind the transformation. The core team members must be senior enough to make decisions (e.g., SVP or VP-level), smart enough to solve challenging problems, and humble enough to roll up their sleeves.
                  </p>
                </div>
              ...
              <section className="cs-section">
                <h2 className="cs-h2">3. Culture - Keep What Works, Embed What&apos;s New</h2>
                ...
                <div className="cs-callout">
                  <p className="mb-0">
                    <strong>Tangible Tip:</strong> Create company-wide awards to align with the fundamental cultural values required in the new organization. The CEO and executive leadership team can leverage an all-associate forum to recognize winners and underscore the cultural norms that get rewarded. Create a robust nomination process, encourage participation, and drive leadership discussions (at multiple levels) on picking winners over several weeks. Build excitement towards the event and follow up with celebratory communication over the following months spotlighting the values.
                  </p>
                </div>
              </section>

              <section className="cs-section">
                <h2 className="cs-h2">4. Communication - Do More, Be Bold and Authentic</h2>
                ...
                <div className="cs-callout">
                  <p className="mb-0">
                    <strong>Tangible Tip:</strong> Don&apos;t just rely on the perspective of executive and/or headquarter staff to draft communications. Assemble focus groups or survey your employees about the transformation to surface their concerns. Then explicitly include responses to their key concerns in the transformation communication. Weave specific employee issues into the dialog in live forums and cascading messaging.
                  </p>
                </div>
              </section>

              <section className="cs-section">
                <h2 className="cs-h2">5. Change Management - Lead by Example</h2>
