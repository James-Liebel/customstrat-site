...
export const metadata: Metadata = articleMetadata("banking-better-position-after-crisis", {
...
export default function BankingOnABetterPositionAfterTheCrisis() {
  return (
    <main className="cs-shell--library relative">
      ...
      <JsonLd schema={articleSchema("banking-better-position-after-crisis")} />
      <JsonLd schema={articleBreadcrumbSchema("banking-better-position-after-crisis")} />
          ...
          <div className="cs-surface">
            <div className="cs-body">
              ...
              <section className="cs-section">
                <p>
                  The other day my 12-year-old son’s savings account statement came and showed a paltry 21 cents of interest. When he asked me what he could do about that, I told him he should get a job! Perhaps he could open a lemonade stand? I also told him that interest rates are near all-time lows and will get better over time. He looked at me like I was crazy as I attempted to explain why that was the case!
                </p>

                <p>
                  The current crisis is hitting not just my son’s savings account, but the entire banking industry - the banks themselves as well as their customers – basically every single one of us. In March of 2020, the Fed Funds rate was effectively cut to zero, the second time in history to hit that mark (the first time was the financial crisis of 2008). COVID shut-downs have impacted household income and forced most to stay home. Meanwhile, banks have had to change their operating model, become enablers of the government programs and help their customers through these unprecedented times.
                </p>

                <p>
                  In the face of all this, how might all of you that are bank customers and for those of you that are banking providers, think about using this short-term financial disruption to position better for the long-term? Having worked with financial services companies and retail banks for over 20 years, I’ve been thinking about this question. Four opportunities for retail banking come to mind that are anchored in the perspective of both the consumer and the banker:
                </p>

                <p>1. Go Digital</p>
                <p>2. Optimize the balance sheet</p>
                <p>3. Invest time in long term planning</p>
                <p>4. Use this as a teaching opportunity.</p>

                <p>
                  Some are of these are unique to the environment we’re in, whereas others are merely accentuated in these times.
                </p>
              </section>

              <section className="cs-section">
                <h2 className="cs-h2">1. Go digital</h2>

                <p>
                  With branches restricting hours and with many people finding extra time on their hands at home, this is the perfect opportunity to get more established with digital banking services.
                </p>
              ...
              <section className="cs-section">
                <h2 className="cs-h2">2. Optimize the balance sheet</h2>

                <p>
                  With rates at historic lows, cash flows disrupted, and markets seeing unprecedented volatility, there is no better time than now to review your balance sheet.
                </p>
              ...
              <section className="cs-section">
                <h2 className="cs-h2">3. Invest time into long term planning</h2>

                <p>
                  With social activities and travel curtailed, many of us have some extra time that we weren’t planning on. Meanwhile, we all have a newfound appreciation for large unforeseen risks. Take this time to tackle that list of long-term financial to-do items to position better for the future.
                </p>
              ...
              <section className="cs-section">
                <h2 className="cs-h2">4. Use this as a teaching opportunity</h2>

                <p>
                  This is the perfect opportunity to invest time with kids, grandkids, nieces and nephews (via video calls for those not in the house of course!) to explore the basics of banking and prepare them for the future.
                </p>
